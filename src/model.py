"""TensorFlow model factory for gesture classification."""
...
def build_gesture_model(num_classes: int, input_shape: tuple[int, int, int] = (64, 64, 3)) -> tf.keras.Model:
    """Construct the CNN used for gesture classification."""
    ...
    model = tf.keras.Model(inputs, outputs, name="gesture_cnn")
    return model
